...
func NewBalanceGet200Response(cryptoSymbol string, address string, cryptoBalance float64, fiatSymbol string, fiatValue float64, exchangeRate float64, change24h float64, timestamp time.Time) *BalanceGet200Response {
